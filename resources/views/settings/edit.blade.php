                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('settings.update', encrypt($setting->id)) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2 @error('language') is-invalid @enderror" name="language">
                                        ...
                                        <option {{ $setting->language == "en" ? 'selected' : '' }} value="en">{{ __('English') }}</option>
                                        <option {{ $setting->language == "ml" ? 'selected' : '' }} value="ml">{{ __('Malayalam') }}</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="terms_and_conditions" name="terms_and_conditions" class="form-control basic-example @error('terms_and_conditions') is-invalid @enderror" placeholder="{{ __('Terms & Conditions') }}">{!! old('terms_and_conditions', $setting->terms_and_conditions) !!}</textarea>
                                </div>
